package com.breezeuttamseeds.features.logoutsync.presentation
...
import com.breezeuttamseeds.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezeuttamseeds.features.billing.api.AddBillingRepoProvider
import com.breezeuttamseeds.features.billing.model.AddBillingInputParamsModel
...
import com.breezeuttamseeds.features.dashboard.presentation.ReasonDialog
...
import com.breezeuttamseeds.features.document.model.AddEditDocumentInputParams
import com.breezeuttamseeds.features.document.model.DocumentAttachmentModel
...
import com.breezeuttamseeds.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.breezeuttamseeds.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.breezeuttamseeds.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.breezeuttamseeds.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezeuttamseeds.features.orderhistory.model.*
...
import com.breezeuttamseeds.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezeuttamseeds.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.breezeuttamseeds.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.breezeuttamseeds.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.breezeuttamseeds.features.timesheet.model.AddTimeSheetInputModel
import com.breezeuttamseeds.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezeuttamseeds.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezeuttamseeds.features.viewAllOrder.model.AddOrderInputProductList
import com.breezeuttamseeds.mappackage.SendBrod
import com.breezeuttamseeds.widgets.AppCustomTextView
import com.breezeuttamseeds.MonitorService
import com.breezeuttamseeds.MySingleton
import com.breezeuttamseeds.features.addshop.model.*
import com.breezeuttamseeds.features.addshop.model.assigntopplist.AddShopUploadImg
import com.breezeuttamseeds.features.addshop.presentation.ShopExtraContactReq
import com.breezeuttamseeds.features.addshop.presentation.multiContactRequestData
...
import com.breezeuttamseeds.features.login.model.GetConcurrentUserResponse
import com.breezeuttamseeds.features.login.model.WhatsappApiData
import com.breezeuttamseeds.features.orderITC.SyncOrd
import com.breezeuttamseeds.features.orderITC.SyncOrdProductL
import com.breezeuttamseeds.features.performance.model.Gps_status_list
import com.breezeuttamseeds.features.performance.model.UpdateGpsInputListParamsModel
import com.breezeuttamseeds.features.returnsOrder.ReturnProductList
import com.breezeuttamseeds.features.returnsOrder.ReturnRequest
import com.breezeuttamseeds.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezeuttamseedslogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezeuttamseedslogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezeuttamseedslogsample/log.zip").path);
