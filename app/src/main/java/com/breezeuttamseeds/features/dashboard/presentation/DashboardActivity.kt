...
import com.breezeuttamseeds.*
import com.breezeuttamseeds.R
import com.breezeuttamseeds.app.*
import com.breezeuttamseeds.app.NewFileUtils.browseDocuments
import com.breezeuttamseeds.app.NewFileUtils.browsePDFDocuments
import com.breezeuttamseeds.app.NewFileUtils.getExtension
import com.breezeuttamseeds.app.domain.*
import com.breezeuttamseeds.app.types.DashboardType
import com.breezeuttamseeds.app.types.FragType
import com.breezeuttamseeds.app.types.TopBarConfig
import com.breezeuttamseeds.app.uiaction.DisplayAlert
import com.breezeuttamseeds.app.utils.*
import com.breezeuttamseeds.app.utils.AppUtils.Companion.isProfile
...
import com.breezeuttamseeds.features.NewQuotation.*
import com.breezeuttamseeds.features.NewQuotation.api.GetQuotRegProvider
import com.breezeuttamseeds.features.NewQuotation.model.ViewDetailsQuotResponse
import com.breezeuttamseeds.features.SearchLocation.SearchLocationFragment
import com.breezeuttamseeds.features.SearchLocation.locationInfoModel
import com.breezeuttamseeds.features.TA.ViewAllTAListFragment
import com.breezeuttamseeds.features.achievement.AchievementFragment
import com.breezeuttamseeds.features.activities.presentation.*
import com.breezeuttamseeds.features.addAttendence.*
import com.breezeuttamseeds.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.breezeuttamseeds.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.breezeuttamseeds.features.addAttendence.model.GetReportToFCMResponse
import com.breezeuttamseeds.features.addAttendence.model.GetReportToResponse
import com.breezeuttamseeds.features.addAttendence.model.Leave_list_Response
import com.breezeuttamseeds.features.addorder.presentation.AddOrderFragment
...
import com.breezeuttamseeds.features.addshop.presentation.AddShopFragment
import com.breezeuttamseeds.features.addshop.presentation.OTPVerificationDialog
import com.breezeuttamseeds.features.addshop.presentation.ScanImageFragment
import com.breezeuttamseeds.features.addshop.presentation.ShowCardDetailsDialog
import com.breezeuttamseeds.features.alarm.model.AlarmData
import com.breezeuttamseeds.features.alarm.presetation.AttendanceReportFragment
import com.breezeuttamseeds.features.alarm.presetation.PerformanceReportFragment
import com.breezeuttamseeds.features.alarm.presetation.VisitReportDetailsFragment
import com.breezeuttamseeds.features.alarm.presetation.VisitReportFragment
import com.breezeuttamseeds.features.attendance.AttendanceFragment
import com.breezeuttamseeds.features.attendance.api.AttendanceRepositoryProvider
import com.breezeuttamseeds.features.attendance.model.AttendanceRequest
import com.breezeuttamseeds.features.attendance.model.AttendanceResponse
import com.breezeuttamseeds.features.averageshop.presentation.AverageShopFragment
import com.breezeuttamseeds.features.avgorder.presentation.AverageOrderFragment
import com.breezeuttamseeds.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.breezeuttamseeds.features.beatCustom.TeamBeatListFragment
import com.breezeuttamseeds.features.billing.presentation.AddBillingFragment
import com.breezeuttamseeds.features.billing.presentation.BillingDetailsFragment
import com.breezeuttamseeds.features.billing.presentation.BillingListFragment
import com.breezeuttamseeds.features.changepassword.presentation.ChangePasswordDialog
import com.breezeuttamseeds.features.chat.model.ChatListDataModel
import com.breezeuttamseeds.features.chat.model.ChatUserDataModel
import com.breezeuttamseeds.features.chat.model.GroupUserDataModel
import com.breezeuttamseeds.features.chat.presentation.*
import com.breezeuttamseeds.features.chatbot.presentation.ChatBotFragment
import com.breezeuttamseeds.features.chatbot.presentation.ChatBotShopListFragment
import com.breezeuttamseeds.features.chatbot.presentation.ReportsFragment
import com.breezeuttamseeds.features.chatbot.presentation.SelectLanguageDialog
import com.breezeuttamseeds.features.commondialog.presentation.CommonDialog
import com.breezeuttamseeds.features.commondialog.presentation.CommonDialogClickListener
import com.breezeuttamseeds.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.breezeuttamseeds.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.breezeuttamseeds.features.commondialogsinglebtn.OnDialogClickListener
import com.breezeuttamseeds.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.breezeuttamseeds.features.contacts.ActivityDtlsFrag
import com.breezeuttamseeds.features.contacts.ContactDtls
import com.breezeuttamseeds.features.contacts.ContactGr
import com.breezeuttamseeds.features.contacts.ContactsAddFrag
import com.breezeuttamseeds.features.contacts.ContactsFrag
import com.breezeuttamseeds.features.contacts.SchedulerViewFrag
import com.breezeuttamseeds.features.contacts.SchedulerAddFormFrag
import com.breezeuttamseeds.features.contacts.TemplateAddFrag
import com.breezeuttamseeds.features.contacts.TemplateViewFrag
import com.breezeuttamseeds.features.dailyPlan.prsentation.AllShopListFragment
import com.breezeuttamseeds.features.dailyPlan.prsentation.DailyPlanListFragment
import com.breezeuttamseeds.features.dailyPlan.prsentation.PlanDetailsFragment
import com.breezeuttamseeds.features.damageProduct.ShopDamageProductListFrag
import com.breezeuttamseeds.features.damageProduct.ShopDamageProductSubmitFrag
import com.breezeuttamseeds.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.breezeuttamseeds.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.breezeuttamseeds.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.breezeuttamseeds.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.breezeuttamseeds.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.breezeuttamseeds.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.breezeuttamseeds.features.dashboard.presentation.model.ContentListResponseModel
import com.breezeuttamseeds.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.breezeuttamseeds.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.breezeuttamseeds.features.device_info.presentation.DeviceInfoListFragment
import com.breezeuttamseeds.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.breezeuttamseeds.features.document.DocumentRepoFeatureNewFragment
import com.breezeuttamseeds.features.document.presentation.DocumentListFragment
import com.breezeuttamseeds.features.document.presentation.DocumentTypeListFragment
import com.breezeuttamseeds.features.document.presentation.OpenFileWebViewFragment
import com.breezeuttamseeds.features.dymanicSection.presentation.AddDynamicFragment
import com.breezeuttamseeds.features.dymanicSection.presentation.AllDynamicListFragment
import com.breezeuttamseeds.features.dymanicSection.presentation.DynamicListFragment
import com.breezeuttamseeds.features.dymanicSection.presentation.EditDynamicFragment
import com.breezeuttamseeds.features.gpsDisabilityScreen.GpsDisableFragment
import com.breezeuttamseeds.features.home.presentation.HomeFragment
import com.breezeuttamseeds.features.homelocation.presentation.HomeLocationFragment
import com.breezeuttamseeds.features.homelocation.presentation.HomeLocationMapFragment
import com.breezeuttamseeds.features.know_your_state.KnowYourStateFragment
import com.breezeuttamseeds.features.lead.LeadFrag
import com.breezeuttamseeds.features.lead.ViewLeadFrag
import com.breezeuttamseeds.features.leaderboard.LeaderBoardFrag
import com.breezeuttamseeds.features.leaveapplynew.LeaveHome
import com.breezeuttamseeds.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.breezeuttamseeds.features.localshops.LocalShopListFragment
import com.breezeuttamseeds.features.localshops.LocalShopListMapFragment
import com.breezeuttamseeds.features.localshops.NearByShopsMapFragment
import com.breezeuttamseeds.features.location.*
import com.breezeuttamseeds.features.location.api.LocationRepoProvider
import com.breezeuttamseeds.features.location.model.*
import com.breezeuttamseeds.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.breezeuttamseeds.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.breezeuttamseeds.features.login.ShopFeedbackEntity
import com.breezeuttamseeds.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.breezeuttamseeds.features.login.presentation.LoginActivity
import com.breezeuttamseeds.features.logout.presentation.api.LogoutRepositoryProvider
import com.breezeuttamseeds.features.logoutsync.presentation.LogoutSyncFragment
import com.breezeuttamseeds.features.marketAssist.MarketAssistTabFrag
import com.breezeuttamseeds.features.marketAssist.ShopDtlsMarketAssistFrag
import com.breezeuttamseeds.features.marketAssist.ShopListMarketAssistFrag
import com.breezeuttamseeds.features.marketing.presentation.MarketingPagerFragment
import com.breezeuttamseeds.features.meetinglist.prsentation.MeetingListFragment
import com.breezeuttamseeds.features.member.MapViewForTeamFrag
import com.breezeuttamseeds.features.member.model.TeamLocDataModel
import com.breezeuttamseeds.features.member.model.TeamShopListDataModel
import com.breezeuttamseeds.features.member.presentation.*
import com.breezeuttamseeds.features.menuBeat.MenuBeatFrag
import com.breezeuttamseeds.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.breezeuttamseeds.features.micro_learning.presentation.MicroLearningListFragment
import com.breezeuttamseeds.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.breezeuttamseeds.features.myallowancerequest.MyallowanceRequestFragment
import com.breezeuttamseeds.features.myjobs.model.CustomerDataModel
import com.breezeuttamseeds.features.myjobs.presentation.*
import com.breezeuttamseeds.features.myorder.presentation.MyOrderListFragment
import com.breezeuttamseeds.features.myprofile.presentation.MyProfileFragment
...
import com.breezeuttamseeds.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.breezeuttamseeds.features.nearbyshops.presentation.BeatListFragment
import com.breezeuttamseeds.features.nearbyshops.presentation.NearByShopsListFragment
import com.breezeuttamseeds.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.breezeuttamseeds.features.nearbyshops.presentation.ShopCallHisFrag
import com.breezeuttamseeds.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.breezeuttamseeds.features.newcollection.CollectionDetailsStatusFragment
import com.breezeuttamseeds.features.newcollection.CollectionShopListFragment
import com.breezeuttamseeds.features.newcollection.NewCollectionListFragment
import com.breezeuttamseeds.features.newcollectionreport.*
import com.breezeuttamseeds.features.notification.NotificationFragment
import com.breezeuttamseeds.features.orderITC.CartListFrag
import com.breezeuttamseeds.features.orderITC.OrderListFrag
import com.breezeuttamseeds.features.orderITC.ProductListFrag
import com.breezeuttamseeds.features.orderITC.ViewNewOrdHisAllFrag
import com.breezeuttamseeds.features.orderITC.ViewNewOrdHistoryFrag
import com.breezeuttamseeds.features.orderITC.ViewOrdDtls
import com.breezeuttamseeds.features.orderList.NewDateWiseOrderListFragment
import com.breezeuttamseeds.features.orderList.NewOrderListFragment
import com.breezeuttamseeds.features.orderList.OrderListFragment
import com.breezeuttamseeds.features.orderdetail.presentation.OrderDetailFragment
import com.breezeuttamseeds.features.orderhistory.ActivityMapFragment
import com.breezeuttamseeds.features.orderhistory.OrderhistoryFragment
import com.breezeuttamseeds.features.orderhistory.TimeLineFragment
import com.breezeuttamseeds.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
...
import com.breezeuttamseeds.features.orderhistory.model.LocationData
import com.breezeuttamseeds.features.pendinglocationinout.PendingOutLocationFrag
import com.breezeuttamseeds.features.performance.GpsStatusFragment
import com.breezeuttamseeds.features.performance.PerformanceFragment
import com.breezeuttamseeds.features.performance.api.UpdateGpsStatusRepoProvider
import com.breezeuttamseeds.features.performance.model.UpdateGpsInputParamsModel
import com.breezeuttamseeds.features.performanceAPP.OwnPerformanceFragment
import com.breezeuttamseeds.features.performanceAPP.PerformanceAppFragment
import com.breezeuttamseeds.features.performanceAPP.allPerformanceFrag
import com.breezeuttamseeds.features.permissionList.ViewPermissionFragment
import com.breezeuttamseeds.features.photoReg.*
import com.breezeuttamseeds.features.privacypolicy.PrivacypolicyWebviewFrag
import com.breezeuttamseeds.features.quotation.presentation.*
import com.breezeuttamseeds.features.reimbursement.presentation.*
import com.breezeuttamseeds.features.report.presentation.*
import com.breezeuttamseeds.features.returnsOrder.*
import com.breezeuttamseeds.features.settings.presentation.SettingsFragment
import com.breezeuttamseeds.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.breezeuttamseeds.features.shopdetail.presentation.*
import com.breezeuttamseeds.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezeuttamseeds.features.stock.StockDetailsFragment
import com.breezeuttamseeds.features.stock.StockListFragment
import com.breezeuttamseeds.features.stockAddCurrentStock.AddShopStockFragment
import com.breezeuttamseeds.features.stockAddCurrentStock.UpdateShopStockFragment
import com.breezeuttamseeds.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.breezeuttamseeds.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.breezeuttamseeds.features.stockCompetetorStock.AddCompetetorStockFragment
import com.breezeuttamseeds.features.stockCompetetorStock.CompetetorStockFragment
import com.breezeuttamseeds.features.stockCompetetorStock.ViewComStockProductDetails
import com.breezeuttamseeds.features.survey.SurveyFrag
import com.breezeuttamseeds.features.survey.SurveyViewDtlsFrag
import com.breezeuttamseeds.features.survey.SurveyViewFrag
import com.breezeuttamseeds.features.task.presentation.AddTaskFragment
import com.breezeuttamseeds.features.task.presentation.CalenderTaskFragment
import com.breezeuttamseeds.features.task.presentation.EditTaskFragment
import com.breezeuttamseeds.features.task.presentation.TaskListFragment
import com.breezeuttamseeds.features.taskManagement.TaskManagementFrag
import com.breezeuttamseeds.features.taskManagement.ViewTaskManagementFrag
import com.breezeuttamseeds.features.timesheet.presentation.AddTimeSheetFragment
import com.breezeuttamseeds.features.timesheet.presentation.EditTimeSheetFragment
import com.breezeuttamseeds.features.timesheet.presentation.TimeSheetListFragment
import com.breezeuttamseeds.features.viewAllOrder.CartFragment
import com.breezeuttamseeds.features.viewAllOrder.OrderTypeListFragment
import com.breezeuttamseeds.features.viewAllOrder.ViewAllOrderListFragment
import com.breezeuttamseeds.features.viewAllOrder.ViewCartFragment
import com.breezeuttamseeds.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.breezeuttamseeds.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.breezeuttamseeds.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.breezeuttamseeds.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.breezeuttamseeds.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.breezeuttamseeds.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.breezeuttamseeds.features.viewPPDDStock.ViewOutstandingFragment
import com.breezeuttamseeds.features.viewPPDDStock.ViewPPDDListFragment
import com.breezeuttamseeds.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.breezeuttamseeds.features.viewPPDDStock.ViewStockFragment
import com.breezeuttamseeds.features.weather.presentation.WeatherFragment
import com.breezeuttamseeds.mappackage.MapActivity
import com.breezeuttamseeds.mappackage.MapActivityWithoutPath
import com.breezeuttamseeds.mappackage.SendBrod
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xbreezeuttamseedslogsample/log").path);
            //27-09-2021
//            val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezeuttamseedslogsample/log").path);
...
//                BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath="/data/user/0/com.breezeuttamseeds/files/Fsmlog.html"
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezeuttamseedslogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezeuttamseedslogsample/log.bak.1").path);
...
//        return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezeuttamseedslogsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
...
//        }
        val bytes = ByteArrayOutputStream()
//        bm!!.compress(Bitmap.CompressFormat.JPEG, 90, bytes)
        var destination = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezeuttamseedslogsample/log")
        val fo: FileOutputStream
        val fo1:FileWriter
        try {
            fo = FileOutputStream(destination)
